   ...
   public function findForAuthentication(string $email)
    {
        return Ms_user::select(
                ...
                'Ms_users.tenant_id as tenant_id',       
