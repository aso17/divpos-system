  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl w-full max-w-md p-6 shadow-lg overflow-y-auto max-h-[95vh]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-xxs">
          {/* Role Name */}
          <div>
            ...
            <input
              ...
              className={inputClasses({ error: !!errors.role_name })}
          ...
          <div>
            ...
            <input
              ...
              className={inputClasses({ error: !!errors.code })}
          ...
          <div className="flex justify-end gap-2 pt-4 border-t mt-2">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 border border-slate-300 rounded text-[10px] font-bold uppercase text-slate-500 hover:bg-slate-50 transition-all"
            >
              Cancel
            </button>
            <SubmitButton
